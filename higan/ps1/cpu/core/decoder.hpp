...
#ifdef DECODER_REGIMM
{
  ...
  op(0x02, BLTZ, RS, IMMi16);
  op(0x03, BGEZ, RS, IMMi16);
  op(0x04, BLTZ, RS, IMMi16);
  op(0x05, BGEZ, RS, IMMi16);
  op(0x06, BLTZ, RS, IMMi16);
  op(0x07, BGEZ, RS, IMMi16);
  op(0x08, BLTZ, RS, IMMi16);
  op(0x09, BGEZ, RS, IMMi16);
  op(0x0a, BLTZ, RS, IMMi16);
  op(0x0b, BGEZ, RS, IMMi16);
  op(0x0c, BLTZ, RS, IMMi16);
  op(0x0d, BGEZ, RS, IMMi16);
  op(0x0e, BLTZ, RS, IMMi16);
  op(0x0f, BGEZ, RS, IMMi16);
  br(0x10, BLTZAL, RS, IMMi16);
  br(0x11, BGEZAL, RS, IMMi16);
  op(0x12, BLTZ, RS, IMMi16);
  op(0x13, BGEZ, RS, IMMi16);
  op(0x14, BLTZ, RS, IMMi16);
  op(0x15, BGEZ, RS, IMMi16);
  op(0x16, BLTZ, RS, IMMi16);
  op(0x17, BGEZ, RS, IMMi16);
  op(0x18, BLTZ, RS, IMMi16);
  op(0x19, BGEZ, RS, IMMi16);
  op(0x1a, BLTZ, RS, IMMi16);
  op(0x1b, BGEZ, RS, IMMi16);
  op(0x1c, BLTZ, RS, IMMi16);
  op(0x1d, BGEZ, RS, IMMi16);
  op(0x1e, BLTZ, RS, IMMi16);
  op(0x1f, BGEZ, RS, IMMi16);
  }
}
